...
- Доступны все обычные классы и все расы из рулбука + Book of Options.
...
**Языки**: количество зависит от Интеллекта, как описано в рулбуке. Выбрать на старте из доступных в кампейне.

### Как создать персонажа с генератором

Используйте мой генератор: https://swords-and-wizardry.ivlev.blog/ (июнь 2024: других не существует). Отчёты об ошибках
и предложения можно присылать мне.
...
Что-то с оружием: выронили, сорвалась тетива, штраф -1 к броску атаки в следующем раунде
...
```
| --------------------------------------------------------------------------------------- |
|                       Правила ниже для компании по Изометрии                            |
|                       изменены, игрокам: пропустите их .)                               |
| --------------------------------------------------------------------------------------- |
```
