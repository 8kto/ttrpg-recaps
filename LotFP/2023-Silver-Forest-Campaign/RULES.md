...
Доли сокровищ высчитываются делением добытых сокровищ на число долей. Например, группа состоит из 5 персонажей игроков (каждый из которых получает полную долю) и трёх наёмников (требующих 1/5 доли т.е. 0.2 доли).
...
Проверка: 5 персонажей по 2 500 = 12 500 sp. Доли наёмников: 3 наёмника по 500 sp = 1 500 sp. Складываем, получаем: 12 500 + 1 500 = `14 000 sp`. Готово, вы великолепны.
